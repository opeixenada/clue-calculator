...
class MapStateTest extends AnyWordSpec with Matchers {
  ...
  "MapState" must {
    ...
    "calculate cycle length with 1-day period" in {
      val state = new MapState()
      state.addEvent(Event(0, 1, parseDateTime("2019-11-01T00:00:00.000Z")))
      state.addEvent(Event(0, 1, parseDateTime("2019-12-01T00:00:00.000Z")))
    ...
    "calculate cycle length with 3-days period" in {
      val state = new MapState()
      state.addEvent(Event(0, 1, parseDateTime("2019-11-01T00:00:00.000Z")))
      state.addEvent(Event(0, 1, parseDateTime("2019-11-02T00:00:00.000Z")))
      state.addEvent(Event(0, 1, parseDateTime("2019-11-03T00:00:00.000Z")))
      state.addEvent(Event(0, 1, parseDateTime("2019-12-01T00:00:00.000Z")))
      state.getAverageCycleLength mustBe 30
    }
    ...
    "calculate average cycle length for 2 users" in {
      ...
      state.addEvent(Event(0, 1, parseDateTime("2019-11-01T00:00:00.000Z")))
      state.addEvent(Event(0, 1, parseDateTime("2019-12-01T00:00:00.000Z")))
      state.addEvent(Event(1, 1, parseDateTime("2019-11-01T00:00:00.000Z")))
      state.addEvent(Event(1, 1, parseDateTime("2019-11-30T00:00:00.000Z")))
